...
?>
    ...
    <?php
        ...
        if( !(isset($_GET['id'])) || !(isset($_GET['folio'])) || !(isset($_GET['tipoadecuacion'])) || !(isset($_GET['importe'])) || !(isset($_GET['numeroOficio']))  ){
            header('Location: login.php');
        }
...
<?php
    $id = $_GET['id'];
    $folio = $_GET['folio'];
    $tipoadecuacion = $_GET['tipoadecuacion'];
        ...
        <script>      
            ...
            function validacion() {
                    ...
                    if(v1 == true  || v2 == true || v3 == true){
                        ...
                        campo = document.getElementById("numeroOficio").value;
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="NuevoCLC.php" style="background: #000; color: #FFF;">Nuevo</a>
        ...
        <div class="container">
            ...
            <div class="panel-group"  >
              <div class="panel  panel-primary">
                <div class="panel-heading">Actualizar Adecuacion Presupuestal</div>
                <div class="panel-body">
                    <form class="form-inline" action="Adecuacion_Actualizar.php" method="post" onsubmit="return validacion()">
                        <div class="form-group">
                            
                            
                        <div class="form-group">
                            <input type="hidden" class="form-control " name="id" required="true" maxlength="11" value="<?php echo $id; ?>">
                        </div>
                        ...
                        <div class="form-group">
                            <label>Importe $</label>
                            <input type="text" class="form-control " name="importe" id="importe" required="true" maxlength="30" value="<?php echo $importe; ?>">
                           
                        </div>
                        <div class="form-group">
                            <label>Folio</label>
                            <input type="text" class="form-control " name="folio" id="folio" required="true" maxlength="10" value="<?php echo $folio; ?>">
                        </div>
                        <div class="form-group">
                            <label>Numero de Oficio</label>
                            <input type="text" class="form-control " name="numeroOficio" id="numeroOficio" required="true" maxlength="20" value="<?php echo $numeroOficio; ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <br>
                            <textarea class="form-control" rows="5" style="width: 300px;" name="tipoMovimiento"><?php echo $tipo; ?></textarea>
                        </div>
                        
                        <div class="form-group" >
                            <label>Observaciones</label>
                            <br>
                            <textarea class="form-control" rows="5" style="width: 300px;" name="observaciones"><?php echo $observaciones; ?></textarea>
                        </div>
                        <br>
                        <br>
                        <br>
                        ...
                        <div class="form-group" >
                            ...
                            <input type="submit" value="Actualizar" class="form-control" style="width: 200px;background: lightseagreen;color: white">
                        </div>
