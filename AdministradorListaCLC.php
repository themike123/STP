            ...
            <table class="table table-bordered" id="Exportar_a_Excel">
                <thead>
                    ...
                    <tr>
                        ...
                        <td colspan="6" style="text-align: center;"><h4>CLC's DE GASTOS DE OPERACIÓN</h4></td>
                        
                        <?php }else{ ?>
                        
                            <td colspan="6" style="text-align: center;"><h4>CLC's DE SERVICIOS PERSONALES E IMPUESTOS</h4></td>
                ...
                <tr class="bg-primary" >
                    ...
                    <th  style="background-color: #337AB7; color: #FFFFFF;">CERE</th>
                ...
                <tbody>
                <?php $universidad = new ListaUniversidades($query, $tipoReporte); ?>
                <?php $universidad->generarlistaCLC(); ?>
                
                    <?php for($i=0; $i<$universidad->size(); $i++){ ?>
                    
                
                                                <?php if($universidad->getLista_Universidades($i)->getListaCLC()->size() == 0){ ?>
                                                        <tr>
                                                            <td> <h3> <?php  echo $universidad->getLista_Universidades($i)->getNombre(); ?> </h3></td>
                                                            <td>  </td>
                                                            <td>  </td>
                                                            <td>  </td>
                                                            <td>  </td>
                                                ...
                                                <?php } ?>
                    <?php $total = 0; ?>
                        <?php for($j=0; $j<$universidad->getLista_Universidades($i)->getListaCLC()->size(); $j++){ ?>
                ...
                <tr>
                    ...
                    <td rowspan="<?php  echo $universidad->getLista_Universidades($i)->getListaCLC()->size(); ?>"> <h3> <?php  echo $universidad->getLista_Universidades($i)->getNombre(); ?> </h3> </td>
                                                
                                    
                            <?php } ?>
                                
                            <td> <?php echo $universidad->getLista_Universidades($i)->getListaCLC()->getListaCLC($j)->getImporte(); ?> </td> 
                            <td> <?php echo $universidad->getLista_Universidades($i)->getListaCLC()->getListaCLC($j)->getFolio(); ?> </td>
                            <td> <?php echo $universidad->getLista_Universidades($i)->getListaCLC()->getListaCLC($j)->getCere(); ?> </td>
                            <td> <?php echo $universidad->getLista_Universidades($i)->getListaCLC()->getListaCLC($j)->getTipoMovimiento(); ?> </td>
                            <td> <?php echo $universidad->getLista_Universidades($i)->getListaCLC()->getListaCLC($j)->getObservaciones(); ?> </td>
                           <?php $total += $universidad->getLista_Universidades($i)->getListaCLC()->getListaCLC($j)->getImporte(); ?>
                </tr>
                        <?php } ?>
