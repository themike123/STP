        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="ReporteAP.php" style="background: #000; color: #FFF;">Adecuaciones Presupuetales</a>
                    </li>
                    <li>
                    ...
                    <form class="form-inline">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="universidad" id="universidad">
                                ...
                                <?php
                                    $universidad = new ListaUniversidades_AP("SELECT * FROM universidad");
