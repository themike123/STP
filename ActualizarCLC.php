...
?>
    ...
    <?php
        ...
        if( !(isset($_GET['id'])) || !(isset($_GET['folio'])) || !(isset($_GET['tipoclc'])) || !(isset($_GET['importe'])) || !(isset($_GET['cere']))  ){
            header('Location: login.php');
        }
        ...
        <script>      
            ...
            function validacion() {
                    ...
                    if(v1 == true  || v2 == true || v3 == true){
                        ...
                        campo = document.getElementById("cere").value;
                        valor = expresion(campo, RegExPattern3);
                        
                        
                        if(valor == false){
                            alert('Cere Solo puede contener numeros ejemplo: 09, 34, 5');
                            document.getElementById("cere").focus();
                        }else{
        ...
        <div class="container">
            ...
            <div class="panel-group"  >
              <div class="panel  panel-primary">
                <div class="panel-heading">Nueva CLC</div>
                <div class="panel-body">
                    <form class="form-inline" action="clc_Actualizar.php" method="post" onsubmit="return validacion()">
                        ...
                        <div class="form-group">
                            <label>Cere</label>
                            <input type="text" class="form-control " name="cere" id="cere" required="true" maxlength="20" value="<?php echo $cere; ?>">
                        </div>
