            ...
            <div class="panel-group"  >
              <div class="panel  panel-primary">
                ...
                <div class="panel-body">
                    <form class="form-inline" action="clc_Nuevo.php" method="post" onsubmit="return validacion()">
                        ...
                        <div class="form-group">
                            <label>Cere</label>
                            <input type="text" class="form-control " name="cere" id="cere" required="true" maxlength="20">
                        </div>
